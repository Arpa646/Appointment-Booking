...
async function run() {
  try {
    ...
    */
    ...
    app.get('/user', verifyJWT, verifyJWT, async (req, res) => {
    ...
    app.post('/booking', async (req, res) => {
      ...
      //  res.send(result);
      const query = { treatment: booking.treatment, selected: booking.selected, clint: booking.clint }
    ...
    app.post('/expert', verifyJWT, verifyAdmin, async (req, res) => {
      const expert = req.body;
      const result = await expertCollection.insertOne(expert)
      res.send(result);
    })
    app.delete('/expert/:email', verifyJWT, verifyAdmin, async (req, res) => {
      const email = req.params.email;
      const filter = { email: email }
